...
type DriverClient interface {
	...
	GetStates(context.Context, *connect.Request[v1.Command]) (*connect.Response[v1.GetStatesResult], error)
	GetDelayedStates(context.Context, *connect.Request[v1.Command]) (*connect.Response[v1.GetDelayedStatesResult], error)
...
func NewDriverClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DriverClient {
	...
	return &driverClient{
		...
		getStates: connect.NewClient[v1.Command, v1.GetStatesResult](
			httpClient,
			baseURL+DriverGetStatesProcedure,
			connect.WithSchema(driverGetStatesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		getDelayedStates: connect.NewClient[v1.Command, v1.GetDelayedStatesResult](
			httpClient,
...
type driverClient struct {
	...
	getStates        *connect.Client[v1.Command, v1.GetStatesResult]
	getDelayedStates *connect.Client[v1.Command, v1.GetDelayedStatesResult]
...
func (c *driverClient) GetStates(ctx context.Context, req *connect.Request[v1.Command]) (*connect.Response[v1.GetStatesResult], error) {
	return c.getStates.CallUnary(ctx, req)
}

// GetDelayedStates calls flowstate.v1.Driver.GetDelayedStates.
func (c *driverClient) GetDelayedStates(ctx context.Context, req *connect.Request[v1.Command]) (*connect.Response[v1.GetDelayedStatesResult], error) {
...
func (UnimplementedDriverHandler) GetStates(context.Context, *connect.Request[v1.Command]) (*connect.Response[v1.GetStatesResult], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("flowstate.v1.Driver.GetStates is not implemented"))
}

func (UnimplementedDriverHandler) GetDelayedStates(context.Context, *connect.Request[v1.Command]) (*connect.Response[v1.GetDelayedStatesResult], error) {
