...
const (
	...
	FlowServiceName = "flowstate.v1.FlowService"
)
...
const (
	...
	FlowServiceExecuteProcedure = "/flowstate.v1.FlowService/Execute"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	flowServiceServiceDescriptor       = v1.File_flowstate_v1_client_proto.Services().ByName("FlowService")
	flowServiceExecuteMethodDescriptor = flowServiceServiceDescriptor.Methods().ByName("Execute")
)

// FlowServiceClient is a client for the flowstate.v1.FlowService service.
type FlowServiceClient interface {
	Execute(context.Context, *connect.Request[v1.ExecuteRequest]) (*connect.Response[v1.ExecuteResponse], error)
}

// NewFlowServiceClient constructs a client for the flowstate.v1.FlowService service. By default, it
...
func NewFlowServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) FlowServiceClient {
	...
	return &flowServiceClient{
		execute: connect.NewClient[v1.ExecuteRequest, v1.ExecuteResponse](
			...
			connect.WithSchema(flowServiceExecuteMethodDescriptor),
...
// Execute calls flowstate.v1.FlowService.Execute.
func (c *flowServiceClient) Execute(ctx context.Context, req *connect.Request[v1.ExecuteRequest]) (*connect.Response[v1.ExecuteResponse], error) {
	return c.execute.CallUnary(ctx, req)
}

// FlowServiceHandler is an implementation of the flowstate.v1.FlowService service.
...
func NewFlowServiceHandler(svc FlowServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/flowstate.v1.FlowService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedFlowServiceHandler) Execute(context.Context, *connect.Request[v1.ExecuteRequest]) (*connect.Response[v1.ExecuteResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("flowstate.v1.FlowService.Execute is not implemented"))
}
